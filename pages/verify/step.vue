<template>
  <div>
    <div class="step">
      <span class="steps" :class="{action:status==3||status==2}">① 企业实名认证</span>
      <span class="steps" :class="{action:status==4}">② 对公账户验证</span>
      <span class="steps" :class="{action:status==5}">③ 完成</span>
    </div>
  </div>
